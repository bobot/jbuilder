...
We need ocamlfind to run this test
  ...
  $ dune build @install --display short --only hello
        ocamlc root/.hello.objs/.byte_objs/hello.{cmi,cmo,cmt}
        ocamlc root/hello.cma
      ocamlopt root/.hello.objs/.native_objs/hello.{cmx,o}
  ...
  Hint: try: dune external-lib-deps --missing --display short --only pas-de-bol @install
      ocamldep root/.pas_de_bol.objs/b.ml.d
        ocamlc root/.pas_de_bol.objs/.byte_objs/pas_de_bol.{cmi,cmo,cmt}
      ocamlopt root/.pas_de_bol.objs/.native_objs/pas_de_bol.{cmx,o}
