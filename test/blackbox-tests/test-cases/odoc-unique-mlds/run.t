Duplicate mld's in the same scope
  ...
  Entering directory 'same-scope'
        ...
        ocamlc lib1/.root_lib1.objs/.byte_objs/root_lib1.{cmi,cmo,cmt}
          odoc _doc/_odoc/lib/root.lib1/root_lib1.odoc
        ocamlc lib2/.root_lib2.objs/.byte_objs/root_lib2.{cmi,cmo,cmt}
...
Duplicate mld's in different scope
  ...
  Entering directory 'diff-scope'
          odoc _doc/_html/highlight.pack.js,_doc/_html/odoc.css
        ocamlc scope1/.scope1.objs/.byte_objs/scope1.{cmi,cmo,cmt}
        ...
        ocamlc scope2/.scope2.objs/.byte_objs/scope2.{cmi,cmo,cmt}
