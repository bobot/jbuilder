  $ env OCAMLFIND_CONF=$PWD/etc/findlib.conf jbuilder build --display short -x foo file @install
      ...
      ocamldep lib/.p.objs/p.ml.d [default.foo]
        ocamlc lib/.p.objs/.byte_objs/p.{cmi,cmo,cmt} [default.foo]
        ocamlc lib/p.cma [default.foo]
      ocamldep bin/.blah.eobjs/blah.ml.d
      ocamldep lib/.p.objs/p.ml.d
        ocamlc lib/.p.objs/.byte_objs/p.{cmi,cmo,cmt}
      ocamlopt lib/.p.objs/.native_objs/p.{cmx,o}
      ocamlopt lib/p.{a,cmxa}
        ocamlc bin/.blah.eobjs/.byte_objs/blah.{cmi,cmo,cmt}
      ocamlopt bin/.blah.eobjs/.native_objs/blah.{cmx,o}
      ocamlopt bin/blah.exe
          blah file
      ocamlopt lib/.p.objs/.native_objs/p.{cmx,o} [default.foo]
      ocamlopt lib/p.{a,cmxa} [default.foo]
      ocamlopt lib/p.cmxs [default.foo]
          blah file [default.foo]
        ocamlc bin/.blah.eobjs/.byte_objs/blah.{cmi,cmo,cmt} [default.foo]
      ocamlopt bin/.blah.eobjs/.native_objs/blah.{cmx,o} [default.foo]
