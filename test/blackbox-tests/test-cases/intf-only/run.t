Successes:
  ...
  Entering directory 'foo'
      ...
      ocamldep .foo.objs/foo.ml.d
        ocamlc .foo.objs/.byte_objs/foo__.{cmi,cmo,cmt}
      ocamlopt .foo.objs/.native_objs/foo__.{cmx,o}
      ocamldep .foo.objs/intf.mli.d
        ocamlc .foo.objs/.byte_objs/foo__Intf.{cmi,cmti}
        ocamlc .foo.objs/.byte_objs/foo.{cmi,cmo,cmt}
        ocamlc foo.cma
      ocamlopt .foo.objs/.native_objs/foo.{cmx,o}
      ocamlopt foo.{a,cmxa}
      ocamlopt foo.cmxs
        ocamlc test/.bar.objs/.byte_objs/bar.{cmi,cmo,cmt}
        ocamlc test/bar.cma
      ocamlopt test/.bar.objs/.native_objs/bar.{cmx,o}
