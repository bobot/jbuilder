Formatting can be checked using the @fmt target:
  ...
  $ dune build --display short @fmt
      ...
      ocamldep fake-tools/.ocamlformat.eobjs/refmt.ml.d
        ocamlc fake-tools/.ocamlformat.eobjs/.byte_objs/ocamlformat.{cmi,cmo,cmt}
      ocamlopt fake-tools/.ocamlformat.eobjs/.native_objs/ocamlformat.{cmx,o}
  ...
  Files _build/default/enabled/ocaml_file.ml and _build/default/enabled/.formatted/ocaml_file.ml differ.
        ocamlc fake-tools/.ocamlformat.eobjs/.byte_objs/refmt.{cmi,cmo,cmt}
      ocamlopt fake-tools/.ocamlformat.eobjs/.native_objs/refmt.{cmx,o}
