...
On the other hand, public libraries may have private preprocessors
  ...
  Entering directory 'private-rewriter'
        ocamlc .ppx_internal.objs/.byte_objs/ppx_internal.{cmi,cmo,cmt}
      ocamlopt .ppx_internal.objs/.native_objs/ppx_internal.{cmx,o}
      ...
      ocamldep .mylib.objs/mylib.pp.ml.d
        ocamlc .mylib.objs/.byte_objs/mylib.{cmi,cmo,cmt}
        ocamlc mylib.cma
      ocamlopt .mylib.objs/.native_objs/mylib.{cmx,o}
...
Unless they introduce private runtime dependencies:
  ...
  You need to give "private_runtime_dep" a public name.
        ocamlc .private_ppx.objs/.byte_objs/private_ppx.{cmi,cmo,cmt}
      ocamlopt .private_ppx.objs/.native_objs/private_ppx.{cmx,o}
...
However, public binaries may accept private dependencies
  ...
  Entering directory 'exes'
      ocamldep .publicbin.eobjs/publicbin.ml.d
        ocamlc .publicbin.eobjs/.byte_objs/publicbin.{cmi,cmo,cmt}
      ocamlopt .publicbin.eobjs/.native_objs/publicbin.{cmx,o}
