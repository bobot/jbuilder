  $ dune exec ./qnativerun/run.exe --display short
    ...
    ocamlmklib q/dllq_stubs$ext_dll,q/libq_stubs$ext_lib
      ...
      ocamldep q/.q.objs/q.mli.d
        ocamlc q/.q.objs/.byte_objs/q.{cmi,cmti}
      ocamlopt q/.q.objs/.native_objs/q.{cmx,o}
      ocamlopt q/q.{a,cmxa}
        ocamlc qnativerun/.run.eobjs/.byte_objs/run.{cmi,cmo,cmt}
      ocamlopt qnativerun/.run.eobjs/.native_objs/run.{cmx,o}
