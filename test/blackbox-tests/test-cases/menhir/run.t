  ...
  Entering directory 'general'
      ...
      ocamldep src/.test.eobjs/test_menhir1.ml.d
        ocamlc src/.test.eobjs/.byte_objs/test_menhir1.{cmi,cmti}
      ocamlopt src/.test.eobjs/.native_objs/test_menhir1.{cmx,o}
        ocamlc src/.test.eobjs/.byte_objs/test_base.{cmi,cmti}
      ocamlopt src/.test.eobjs/.native_objs/test_base.{cmx,o}
        ocamlc src/.test.eobjs/.byte_objs/lexer1.{cmi,cmo,cmt}
      ocamlopt src/.test.eobjs/.native_objs/lexer1.{cmx,o}
        ocamlc src/.test.eobjs/.byte_objs/lexer2.{cmi,cmo,cmt}
        ocamlc src/.test.eobjs/.byte_objs/test.{cmi,cmo,cmt}
      ocamlopt src/.test.eobjs/.native_objs/test.{cmx,o}
      ocamlopt src/.test.eobjs/.native_objs/lexer2.{cmx,o}
  ...
  Entering directory 'cmly'
      ...
      ocamldep .test.eobjs/test_menhir1.ml.d
        ocamlc .test.eobjs/.byte_objs/test_menhir1.{cmi,cmti}
      ocamlopt .test.eobjs/.native_objs/test_menhir1.{cmx,o}
