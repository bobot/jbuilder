...
Test that going throught the -ppx option of the compiler works
  ...
  args:--as-ppx --cookie library-name="test_ppx_staged"
        ocamlc .test_ppx_staged.objs/.byte_objs/test_ppx_staged.{cmi,cmo,cmt}
  tool name: ocamlc
  args:--as-ppx --cookie library-name="test_ppx_staged"
...
Test using installed drivers
  ...
  Entering directory 'jbuild-driver'
        ocamlc .testdriver.objs/.byte_objs/testdriver.{cmi,cmo,cmt}
        ocamlc testdriver.cma
      ocamlopt .testdriver.objs/.native_objs/testdriver.{cmx,o}
      ...
      ocamldep .test_ppx_args.objs/test_ppx_args.pp.ml.d
        ocamlc .test_ppx_args.objs/.byte_objs/test_ppx_args.{cmi,cmo,cmt}
        ocamlc test_ppx_args.cma
      ocamlopt .test_ppx_args.objs/.native_objs/test_ppx_args.{cmx,o}
